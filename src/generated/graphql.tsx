...
export enum TimezoneEnum {
  ...
  /** Argentine - San Salvador de Jujuy */
  ...
  /** Argentine - San Miguel de Tucumán */
...
export type PostBySlugQuery = (
  ...
  & { postBy?: Maybe<(
    { __typename?: 'Post' }
    & Pick<Post, 'id' | 'content' | 'title' | 'date'>
    & { featuredImage?: Maybe<(
      { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge' }
      & { node?: Maybe<(
        { __typename?: 'MediaItem' }
      ...
      & { node?: Maybe<(
        { __typename?: 'ContentType' }
        & Pick<ContentType, 'name'>
      )> }
    )>, seo?: Maybe<(
      { __typename?: 'PostTypeSEO' }
      & Pick<PostTypeSeo, 'title'>
    )> }
  )> }
);
...
export type PostsQuery = (
  ...
  & { posts?: Maybe<(
    ...
    & { nodes?: Maybe<Array<Maybe<(
      { __typename?: 'Post' }
      & Pick<Post, 'id' | 'uri' | 'title' | 'slug' | 'excerpt'>
      & { featuredImage?: Maybe<(
        { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge' }
        & { node?: Maybe<(
          { __typename?: 'MediaItem' }
          & Pick<MediaItem, 'altText' | 'sourceUrl' | 'srcSet' | 'sizes'>
        )> }
      )>, seo?: Maybe<(
        { __typename?: 'PostTypeSEO' }
        & Pick<PostTypeSeo, 'metaDesc'>
      )>, categories?: Maybe<(
        { __typename?: 'PostToCategoryConnection' }
        & { nodes?: Maybe<Array<Maybe<(
          { __typename?: 'Category' }
